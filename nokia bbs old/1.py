...
#get url source, from begin_page to end_page, write to file 00001.html to 00005.html
...
#not used. get cookie form mozilla and write to file
def saveCookie(file):
...
#common function, set company proxy
def setproxy(proxy):
